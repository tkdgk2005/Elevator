...
/**
 * Interface to make the FrameView graphics work with your elevator if using calls to the elevator thread
 * , not message passing.
...
public interface FrameGUI
{
	...
	public String getInfo();			// get any other general information you might want to display 
}
